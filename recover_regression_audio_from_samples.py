...
Purpose:
  Find WAV/audio files that tests reference, search the sample library, and copy
  the found files into:

    /Volumes/T9/testbed/Aaron_Sound_Sorter/tests/regression_audio
...
Run:
    ...
    python3 recover_regression_audio_from_samples.py

Stronger search:

    python3 recover_regression_audio_from_samples.py --search-root /Volumes/T9
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Folder to search recursively. Can be repeated. "
...
def main(argv: list[str]) -> int:
    ...
    if counts["missing"]:
        ...
        print("  python3 recover_regression_audio_from_samples.py --search-root /Volumes/T9")
        return 1
