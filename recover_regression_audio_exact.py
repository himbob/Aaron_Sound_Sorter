...
Default search roots:
  ...
  /Volumes/T9/testbed/Aaron_Sound_Sorter/tests/acceptance/locked_smoke_v1/samples

Run:
  python3 recover_regression_audio_exact.py

Wider search:
  python3 recover_regression_audio_exact.py --search-root /Volumes/T9

Overwrite existing recovered files:
  python3 recover_regression_audio_exact.py --overwrite
"""
...
TARGETS: list[RestoreTarget] = [
    ...
    RestoreTarget("regression_audio", "04_Dmn_176bpm_bass.wav", "MS_TLV1_03_The Way It Is_Bass_Eminor_98bpm_Dry.wav", True),
    RestoreTarget("regression_audio", "04.bass_92bpm_Em.wav", "MS_TLV1_03_The Way It Is_Bass_Eminor_98bpm_Dry.wav", True),
    RestoreTarget("regression_audio", "DOJO_CGNB_Female_Vocal_Shot_01_D.wav", "DOJO_CGNB_Female_Vocal_Shot_01_D.wav", True),
    ...
    RestoreTarget("regression_audio", "SCY095_03_Drums_Top_Loop_90bpm_01.wav", "SCY095_03_Drums_Top_Loop_90bpm_01.wav", False),
    RestoreTarget("regression_audio", "1.Saxophone_1_110bpm_Am.wav", "AA_JBL_78bpm_Cm_Sax_Loop_1.wav", True),
    RestoreTarget("regression_audio", "HipHopTapes_28_Saxophone_D#m_90bpm.wav", "HipHopTapes_28_Saxophone_D#m_90bpm.wav", True),
    ...
    # v23
    RestoreTarget("regression_audio_v23_voice_short_hit_guard", "DOJO_CGNB_Female_Vocal_Shot_01_D.wav", "DOJO_CGNB_Female_Vocal_Shot_01_D.wav", True),
    ...
    RestoreTarget("regression_audio_drum_loop_steal_guard", "Full Drum Loop 03 - 78BPM.wav", "Full Drum Loop 03 - 78BPM.wav", False),
    RestoreTarget("regression_audio_drum_loop_steal_guard", "JL_TDBL_Drum Full_act up_138bpm.wav", "JL_TDBL_Drum Full_act up_138bpm.wav", False),
    RestoreTarget("regression_audio_drum_loop_steal_guard", "SCY097_03_Drums_Full_Loop_90bpm_03.wav", "SCY097_03_Drums_Full_Loop_90bpm_03.wav", False),
    RestoreTarget("regression_audio_drum_loop_steal_guard", "US_JF_Drum_140_Dapocket_FULL.wav", "US_JF_Drum_140_Dapocket_FULL.wav", False),
    RestoreTarget("regression_audio_drum_loop_steal_guard", "2.Drum Loop_1_100bpm.wav", "2.Drum Loop_1_100bpm.wav", False),
    RestoreTarget("regression_audio_drum_loop_steal_guard", "A1_Kick_Clap_Loop_99bpm.wav", "A1_Kick_Clap_Loop_99bpm.wav", False),
    RestoreTarget("regression_audio_drum_loop_steal_guard", "MKS_98_Beat1.wav", "MKS_98_Beat1.wav", False),
    RestoreTarget("regression_audio_drum_loop_steal_guard", "QUp_DzU_DrumLp_03_100bpm.wav", "QUp_DzU_DrumLp_03_100bpm.wav", False),
    RestoreTarget("regression_audio_drum_loop_steal_guard", "WS2_KIT_1_WestCoast_Drum_&_Perc_Loop_101BPM.wav", "WS2_KIT_1_WestCoast_Drum_&_Perc_Loop_101BPM.wav", False),
    ...
    RestoreTarget("regression_audio_drum_loop_steal_guard", "FL_TR_Kit02_96_Bass_Loop_Synth_Gm.wav", "FL_TR_Kit02_96_Bass_Loop_Synth_Gm.wav", False),
    RestoreTarget("regression_audio_drum_loop_steal_guard", "AA_JBL_78bpm_Cm_Sax_Loop_1.wav", "AA_JBL_78bpm_Cm_Sax_Loop_1.wav", True),
    RestoreTarget("regression_audio_drum_loop_steal_guard", "DOJO_FBP_Female_Vocal_Shout.wav", "DOJO_FBP_Female_Vocal_Shout.wav", True),
    RestoreTarget("regression_audio_drum_loop_steal_guard", "DOJO_CGNB_Female_Vocal_Shot_01_D.wav", "DOJO_CGNB_Female_Vocal_Shot_01_D.wav", True),

    # v25
    RestoreTarget("regression_audio_v25_transition_reverb", "GrimyHipHop_Saxophone_26_Fm_Melody_Dark_Dusty_Warm_Loop_84bpm.wav", "GrimyHipHop_Saxophone_15_Fm_Melody_Dark_Dusty_Warm_Loop_84bpm.wav", True),
    RestoreTarget("regression_audio_v25_transition_reverb", "Riser Short Effect.wav", "Riser Short Effect.wav", True),
    RestoreTarget("regression_audio_v25_transition_reverb", "US_CHV2_Vocal_female_shouts_processed_13.wav", "DOJO_FBP_Female_Vocal_Shout.wav", True),
    RestoreTarget("regression_audio_v25_transition_reverb", "Piano 1 - 80 Bpm - Key C.wav", "Piano 1 - 80 Bpm - Key C.wav", True),

    # v26
    RestoreTarget("regression_audio_v26_fx_smoke_reverb", "HipHopTapes_29_Saxophone_D#m_90bpm.wav", "HipHopTapes_29_Saxophone_D#m_90bpm.wav", True),
    RestoreTarget("regression_audio_v26_fx_smoke_reverb", "SCY093_02_Sax_Loop_KeyAbm_89bpm_01.wav", "SCY097_03_Sax_Loop_KeyEm_90bpm_01.wav", True),
    RestoreTarget("regression_audio_v26_fx_smoke_reverb", "ABOUTME_94_DRUMLOOP.wav", "ABOUTME_94_DRUMLOOP.wav", False),

    # v28 FX ZIP matrix
    RestoreTarget("regression_audio_v28_fx_zip_matrix", "AA_JBL_78bpm_Cm_Sax_Loop_1.wav", "AA_JBL_78bpm_Cm_Sax_Loop_1.wav", True),
    RestoreTarget("regression_audio_v28_fx_zip_matrix", "AMV_VRNB1_102_brass_saxophone_loop_cranesinthesky_Am.wav", "Brass_Saxophone_RnB_Multi_Instrument_F_Minor_80BPM.wav", True),
    RestoreTarget("regression_audio_v28_fx_zip_matrix", "EWS_Keys_resampled_HipHop_RnB_G_Major_88BPM.wav", "EWS_Keys_resampled_HipHop_RnB_G_Major_88BPM.wav", True),
    RestoreTarget("regression_audio_v28_fx_zip_matrix", "WS2_KIT_1_Electric_Piano_Chords_Fm_101BPM.wav", "WS2_KIT_1_Electric_Piano_Chords_Fm_101BPM.wav", True),
    RestoreTarget("regression_audio_v28_fx_zip_matrix", "GS_Synth_Gangsta_Lead_G#min_97bpm.wav", "GS_Synth_Gangsta_Lead_G#min_97bpm.wav", False),
    RestoreTarget("regression_audio_v28_fx_zip_matrix", "MS_TLV1_03_The Way It Is_Synth Lead 1_Eminor_98bpm_Wet.wav", "MS_TLV1_03_The Way It Is_Synth Lead 1_Eminor_98bpm_Wet.wav", False),
    RestoreTarget("regression_audio_v28_fx_zip_matrix", "Money_vocals_female_rap_110bpm.wav", "Money_vocals_female_rap_110bpm.wav", True),
    RestoreTarget("regression_audio_v28_fx_zip_matrix", "Phonk_Rap_Vocals_26_keyCmin_151bpm.wav", "Phonk_Rap_Vocals_26_keyCmin_151bpm.wav", True),
    RestoreTarget("regression_audio_v28_fx_zip_matrix", "Vocal Phrase We Up 140bpm.wav", "DOJO_FBP_Female_Vocal_Shout.wav", True),
    RestoreTarget("regression_audio_v28_fx_zip_matrix", "Stab 3.wav", "DOJO_CGNB_Female_Vocal_Shot_01_D.wav", True),
    RestoreTarget("regression_audio_v28_fx_zip_matrix", "MS_O_01_Outlaw_Fx Police_D#minor_91bpm_Wet.wav", "MS_O_01_Outlaw_Fx Police_D#minor_91bpm_Wet.wav", True),
    ...
    # full thread matrix
    RestoreTarget("regression_audio_thread_matrix", "AA_JBL_74bpm_Am_Sax_Loop_18.wav", "AA_JBL_74bpm_Am_Sax_Loop_18.wav", False),
    RestoreTarget("regression_audio_thread_matrix", "AA_JBL_78bpm_Cm_Sax_Loop_1.wav", "AA_JBL_78bpm_Cm_Sax_Loop_1.wav", True),
    RestoreTarget("regression_audio_thread_matrix", "AA_JBL_86bpm_Cm_Sax_Loop_12.wav", "AA_JBL_86bpm_Cm_Sax_Loop_12.wav", False),
    RestoreTarget("regression_audio_thread_matrix", "AA_JBL_90bpm_Em_Sax_Loop_3.wav", "AA_JBL_90bpm_Em_Sax_Loop_3.wav", False),
    RestoreTarget("regression_audio_thread_matrix", "AMV_VRNB1_102_brass_saxophone_loop_cranesinthesky_Am.wav", "Brass_Saxophone_RnB_Multi_Instrument_F_Minor_80BPM.wav", True),
    RestoreTarget("regression_audio_thread_matrix", "GrimyHipHop_Saxophone_26_Fm_Melody_Dark_Dusty_Warm_Loop_84bpm.wav", "GrimyHipHop_Saxophone_15_Fm_Melody_Dark_Dusty_Warm_Loop_84bpm.wav", True),
    RestoreTarget("regression_audio_thread_matrix", "HipHopTapes_28_Saxophone_D#m_90bpm.wav", "HipHopTapes_28_Saxophone_D#m_90bpm.wav", True),
    RestoreTarget("regression_audio_thread_matrix", "HipHopTapes_29_Saxophone_D#m_90bpm.wav", "HipHopTapes_29_Saxophone_D#m_90bpm.wav", True),
    RestoreTarget("regression_audio_thread_matrix", "SCY093_02_Sax_Loop_KeyAbm_89bpm_01.wav", "SCY097_03_Sax_Loop_KeyEm_90bpm_01.wav", True),
    ...
    RestoreTarget("regression_audio_thread_matrix", "Full Drum Loop 03 - 78BPM.wav", "Full Drum Loop 03 - 78BPM.wav", False),
    RestoreTarget("regression_audio_thread_matrix", "NDAEV4_FULL_DRUM_LOOP_01_AFTERLIFE_74BPM.wav", "NDAEV4_FULL_DRUM_LOOP_01_AFTERLIFE_74BPM.wav", False),
    RestoreTarget("regression_audio_thread_matrix", "THO_ck4_drums top_130 bpm.wav", "THO_ck4_drums top_130 bpm.wav", False),
    RestoreTarget("regression_audio_thread_matrix", "DOJO_CGNB_Female_Vocal_Shot_01_D.wav", "DOJO_CGNB_Female_Vocal_Shot_01_D.wav", True),
    RestoreTarget("regression_audio_thread_matrix", "DOJO_FBP_Female_Vocal_Shout.wav", "DOJO_FBP_Female_Vocal_Shout.wav", True),
    RestoreTarget("regression_audio_thread_matrix", "Money_vocals_female_rap_110bpm.wav", "Money_vocals_female_rap_110bpm.wav", True),
...
def default_search_roots(project_root: Path) -> list[Path]:
    ...
    return [
        ...
        project_root / "tests" / "acceptance" / "locked_smoke_v1" / "samples",
    ]
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help=f"Project root. Default auto-detect or {DEFAULT_PROJECT_ROOT}",
    )
    parser.add_argument(
        "--search-root",
        type=Path,
        action="append",
        default=None,
        help="Search root. Can be repeated. Default searches music_production/samples and locked smoke samples.",
    )
    parser.add_argument(
        "--overwrite",
        action="store_true",
...
def main(argv: list[str]) -> int:
    ...
    missing_after_loose = {
        name for name in wanted_source_names
        if normalize_name(name) not in loose_index
    }
    ...
    if counts["missing_required"]:
        ...
        print("  python3 recover_regression_audio_exact.py --search-root /Volumes/T9 --strict")
